...
-- Tiempo de generación: 06-05-2022 a las 03:06:54
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `registrarFeedback` (IN `U_idEvaluado` INT, IN `U_idEvaluador` INT, IN `U_idPregunta` INT, IN `U_idPeriodo` INT, IN `U_respuesta` LONGTEXT)   BEGIN 
...
(42, 1, 3.1, '2022-05-06 01:05:26'),
(42, 2, 2.2, '2022-05-06 01:05:26'),
(42, 3, 2.3, '2022-05-06 01:05:26');
...
(7, 2, 2.3, '2020-02-07 23:00:00'),
(7, 3, 4.1, '2020-02-07 23:00:00'),
(8, 1, 5.1, '2020-11-17 14:10:01'),
(8, 2, 5.2, '2020-11-17 14:10:01'),
(8, 3, 4.3, '2020-11-17 14:10:01'),
(9, 1, 2.3, '2020-01-14 23:00:00'),
(9, 2, 1.2, '2020-01-14 23:00:00'),
(9, 3, 1.3, '2020-01-14 23:00:00'),
(10, 1, 3.3, '2020-03-10 23:00:00'),
...
(42, 'Adriana Carolina', 'Gómez', '', 'adriana@example.com', '$2a$12$jQwwdMSB..VJUqWY6I2jt.dSQ2n6howjC9t0DMQ4vjMefMjMbVUqe', 1, 'iconperfil.png', 1);
...
(2, 1, 3, 13, '5'),
(2, 1, 4, 13, '5'),
(2, 1, 21, 13, 'Sabe identificar los requerimientos de un sistema empresarial'),
(2, 1, 12, 13, '2'),
(2, 1, 19, 13, '5'),
(11, 3, 7, 13, '5'),
(11, 3, 8, 13, '5'),
...
(24, 3, 22, 21, '2'),
(24, 3, 3, 21, '3'),
(24, 3, 21, 21, 'Debido a que muestra uan gran disposición para trabajar a gran escala'),
(24, 3, 11, 21, '2'),
(24, 3, 16, 21, '3'),
(3, 1, 5, 91, '5'),
(3, 1, 6, 91, '5'),
...
(2, 1, 22, 190, '5'),
(2, 1, 3, 190, '5'),
(2, 1, 21, 190, 'Sí considero asignarle la progrmación empresarial, debido a que es capaz de implementar funciones a muy alto nivel'),
(2, 1, 12, 190, '5'),
(2, 1, 19, 190, '5'),
(2, 3, 22, 190, '3'),
(2, 3, 3, 190, '5'),
(2, 3, 21, 190, 'Se lo merece, es capaz de pensar en miles de usuarios concurrentes'),
(2, 3, 12, 190, '5'),
(2, 3, 19, 190, '3'),
(2, 1, 22, 206, '4'),
(2, 1, 3, 206, '5'),
(2, 1, 21, 206, 'Lo considero apropiado porque generó una aplicación para miles de usuarios'),
(2, 1, 12, 206, '4'),
(2, 1, 19, 206, '5'),
(26, 1, 7, 206, '5'),
(26, 1, 8, 206, '3'),
...
(1, 2, 6, 206, '5'),
(1, 2, 13, 206, '4'),
(1, 2, 23, 206, 'Sí, se relaciona con todos los miembros del chapter'),
(1, 2, 17, 206, '3'),
(1, 4, 5, 218, '4'),
(1, 4, 6, 218, '5'),
(1, 4, 13, 218, '3'),
(1, 4, 23, 218, 'Sí. Siempre está al tanto de nosotros'),
(1, 4, 17, 218, '5'),
(1, 5, 5, 218, '5'),
(1, 5, 6, 218, '4'),
(1, 5, 13, 218, '5'),
(1, 5, 23, 218, 'Sí, es muy bueno en ello ya que promueve la convivencia'),
(1, 5, 17, 218, '4'),
(4, 5, 7, 218, '4'),
(4, 5, 14, 218, '5'),
(4, 5, 17, 218, '4'),
...
(1, 26, 6, 218, '4'),
(1, 26, 13, 218, '4'),
(1, 26, 23, 218, 'Sí, siempre promueve la convivencia'),
(1, 26, 17, 218, '3'),
(1, 3, 5, 218, '5'),
(1, 3, 6, 218, '4'),
(1, 3, 13, 218, '4'),
(1, 3, 23, 218, 'Puede hablar con cualquier miembro del chapter sin problemas'),
(1, 3, 17, 218, '5');
...
(1, 2, 3, 19, 13, 218, NULL, '2022-05-05 11:23:45', NULL);
