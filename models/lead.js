...
module.exports = class ChapterLead {
    ...
    //Para obtener todos los miebros del chapter
    static fecthDimEmpleadodos() {
        return db.execute('SELECT * from dimempleado;');

    }

    static fecthDimEmpleado2() {
        return db.execute('SELECT * from dimempleado;');

    }

    static fecthDimEmpleado(id) {
        return db.execute('SELECT * FROM empleado E, dimempleado D WHERE E.idEmpleado = D.idEmpleado AND E.idEmpleado = 1 ORDER BY D.fecha DESC LIMIT 3;');
