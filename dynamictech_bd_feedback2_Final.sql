...
-- Generation Time: May 02, 2022 at 06:37 PM
...
--
-- Table structure for table `cuestionario_actual`
--
...
(5, 'Oriana', 'Gaterol', '', 'orianaGaterol@gmail.com', '$2a$12$TLGpwv8JrcruiLU4F45J3..874bkupkIvYrrfXSWMx19.Vz8nLz7a', 5, 'iconperfil.png', 1),
...
(20, 'Matías', 'Becerra', NULL, 'matiasBecerra@gmail.com', '$2a$12$daoeu2mHhK66vYNQaKsdqOsCOLnk7BmVhGBzUzUsn6a1meSv7iA4.', 6, 'iconperfil.png', 1),
...
(218, 'Mayo-Mayo', '2022-05-01', '2022-05-26', 2022);
...
--
-- Indexes for table `cuestionario_actual`
--
...
--
ALTER TABLE `cuestionario`
  MODIFY `idCuestionario` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT for table `cuestionario_actual`
--
ALTER TABLE `cuestionario_actual`
  MODIFY `idCuestionario` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
...
--
ALTER TABLE `periodo`
  MODIFY `idPeriodo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=227;
